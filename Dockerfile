...
# install nginx
RUN apt-get update && apt-get install nginx vim -y --no-install-recommends && apt-get install -y xmlsec1
...
RUN mkdir -p /opt/app/openlxp-xds
