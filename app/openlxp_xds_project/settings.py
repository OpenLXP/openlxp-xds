...
# SECURE_REDIRECT_EXEMPT = ['http://localhost:8100/admin/login/?next=/admin/', 'http://dev-xds2-admin.deloitteopenlxp.com/health', 'http://dev-xds-admin.deloitteopenlxp.com/health']
